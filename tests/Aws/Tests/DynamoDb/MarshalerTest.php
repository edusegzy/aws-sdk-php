...
JSON;
        ...
        $m = new Marshaler;
        $this->assertEquals($expected, $m->marshalDocument($json));
    }
...
JSON;
    ...
    public function testErrorIfUnmarshalingUnknownType()
    {
        ...
        $m->unmarshalValue(array('BOMB' => 'BOOM'));
    }
}
